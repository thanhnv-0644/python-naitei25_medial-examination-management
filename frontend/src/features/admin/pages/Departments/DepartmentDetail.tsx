  ...
  useEffect(() => {
    const fetchDepartmentData = async () => {
      try {
        ...
        try {
          const doctorsData = await departmentService.getDoctorsByDepartmentId(
            numericId
          );
          ...
          setDepartment((prev) => {
            ...
            return {
              ...prev,
              staffCount: (doctorsData as Doctor[]).length,
              headDoctorName,
            };
          });
        } catch (docError) {
        ...
        return (
          <div>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
              ...
              <div className="bg-white p-5 rounded-lg shadow-sm">
                ...
                <div className="space-y-3">
                  <div className="flex">
                    ...
                    <span>
                      {department.headDoctorName || t("common.notAvailable")}
                    </span>
                  </div>
                  <div className="flex">
                    <span className="font-medium w-32 text-gray-600">
                    ...
                    <span>
                      {department.staffCount} {t("common.people")}
                    </span>
                  </div>
                  <div className="flex">
                    <span className="font-medium w-32 text-gray-600">
              ...
              <div className="bg-white p-5 rounded-lg shadow-sm">
                <h3 className="text-lg font-medium text-gray-800 mb-4">
                  {t("common.activityStats")}
                </h3>
                <div className="grid grid-cols-2 gap-4">
                  <div className="bg-blue-50 p-4 rounded-lg">
                    <p className="text-sm text-gray-600">
                      {t("common.totalPatients")}
                    </p>
            ...
            <div className="bg-white p-5 rounded-lg shadow-sm mb-6">
              ...
              <p className="text-gray-600">
                {department.description || t("common.noDescription")}
              </p>
            </div>
            {/* Nhân sự nổi bật */}
            <div className="bg-white p-5 rounded-lg shadow-sm">
              <h3 className="text-lg font-medium text-gray-800 mb-4">
                {t("common.featuredStaff")}
              </h3>
                    ...
                    <tr key={doctor.doctorId}>
                      ...
                      <td className="px-6 py-4 whitespace-nowrap">
                        <div className="text-sm text-gray-900">
                          {doctor.specialization || t("common.notAvailable")}
                        </div>
                      </td>
                      <td className="px-6 py-4 whitespace-nowrap">
                        <div className="text-sm text-gray-900">
                      ...
                      <td className="px-6 py-4 whitespace-nowrap text-sm">
                        <div className="flex gap-2">
                          <button
                            ...
                            onClick={() =>
                              navigate(`/admin/doctors/schedule/${doctor.id}`)
                            }
                          >
                          ...
                          <button
                            ...
                            onClick={() =>
                              navigate(`/admin/doctors/detail/${doctor.id}`)
                            }
                          >
                            {t("common.details")}
                          </button>
